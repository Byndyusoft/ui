...
const ElementsList = (): React.ReactNode => (
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '1rem' }}>
        ...
        <img id="image" src="https://images.unsplash.com/photo-1703622603725-a6a102e12fbc?q=80&w=300" alt="Картинка" />
    </div>
);
...
export const Sandbox = (): React.ReactNode => (
    <div className={styles.container}>
        <div>
            <h3>reset-css OFF</h3>
            <Frame width={500} height={500} className={styles.listContainer}>
                <ElementsList />
            </Frame>
        </div>
        <div>
            <h3>reset-css ON</h3>
            <div className={cn(styles.listContainer, styles.listContainerWithReset)}>
                <ElementsList />
            </div>
        </div>
    </div>
